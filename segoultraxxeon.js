...
break
  case 'totalfeature':
        ...
        break
            ...
            let me = m.sender
            let xmenu_oh = `
*Hallo Kak, Aku Adalah HiraBOT MD V1*
ketik .allmenu untuk melihat liat menu ku
...
if (typemenu === 'v1') {
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        document: {
                           url: 'https://img101.pixhost.to/images/153/547648844_skyzopedia.jpg'
                        },
                        caption: xmenu_oh,
                        mimetype: 'application/zip',
                        fileName: ownername,
      ...
      title: botname,
      body: ownername,
      thumbnailUrl: 'https://img101.pixhost.to/images/153/547648844_skyzopedia.jpg',
      sourceUrl: ``,
      mediaType: 1,
      renderLargerThumbnail: true
      }
